...
function command(value)
{
	switch(value)
	{
		...
		case "/reiniciar":
	    intervalMessage = setInterval(function(){message();},280000);API.chatLog("Reiniciado o BOT ",false);$(document).ready(function(){
...
function command(value)
{
	switch(value)
	{
		...
		case "/reiniciar":
	    intervalMessage = setInterval(function(){message();},280000);API.chatLog("Bot Reiniciando em ",true);API.chatLog("3..2..1",true);API.chatLog("Troco Fans - Ligado V.1.2",false);API.chatLog("Editado por - Avengers ",false);API.chatLog("Para ver os comandos digite /comandos ", false);API.chatLog("Qualquer coisa me adicione no facebook: https://www.facebook.com/MateusVicentin ", false);
		break;
