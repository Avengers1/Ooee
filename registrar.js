...
SoundUniverseBot.prototype = {
	_lang:function(){
		...
		this.lang['en']['STATS'] 			=	'@%username% Estatistica da Sala - Legais: %woots%, Chatos: %mehs%, Votos: %votes%, Grab: %curates%.';
		this.lang['en']['STATS2'] 			=	'@%username% Estatistica da Sala- Musicas: %songs%, Puladas: %skips%, Usuarios Registrados: %users%.';
		
		this.lang['en']['USERSTATS'] 		=	'@%username% [%target% stats] Entrou na sala: %joins% | Legais: %woots% | Chatos: %mehs% | Votos: %votes% | ';
		this.lang['en']['USERSTATS'] 		+=	' Grabs: %curates% | Musicas: %songs% | Puladas: %skips%';
						
		this.lang['en']['PLAYED'] 		= 	'%username% uLTIMA Musica: %trackauthor% - %tracktitle%';
		this.lang['en']['PLAYED'] 		+=	' [Estatistica: :+1: %woot% | :purple_heart: %love% | :-1: %meh%]';
		
		this.lang['en']['TOO_LONG']					= '%username% a Musica e muito Longa';
		
		this.lang['en']['LANG_CHANGED']				= '@%username% O idioma é definido como %code%.';
		this.lang['en']['ALREADY_REGISTERED']		= '@%username% Voce ja esta registrado';
		this.lang['en']['NOT_REGISTERED']			= '@%username% Voce não esta cadastrado digite .register';
		this.lang['en']['REGISTER'] 				= '@%username% Você foi registrado';
		this.lang['en']['USER_NOT_FOUND']			= '@%username% O Usuario registrado %target% não pode ser encontrado';
		this.lang['en']['USER_FAN']					= '@%username% :kiss:';
		
		this.lang['en']['STAFF_REQUIRED']			= '@%username% Você deve estar na equipe para usar este comando. (%staff%)';
